...
class Zonasi extends CI_Controller
{
	...
	public function save()
	{
		...
		$data = array(
			...
			'daerah_zonasi' => $this->input->post('daerah', TRUE)
		);
		$this->zonasi->save($data);

		redirect(base_url('kecamatan/zonasi?alert=success&message=' . urlencode('Berhasil Input Data')));
	}
	...
	public function update()
	{
		...
		redirect(base_url('kecamatan/zonasi?alert=info&message=' . urlencode('Berhasil Update Data')));
	}
