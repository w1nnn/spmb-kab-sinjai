...
class Manage extends CI_Controller
{
	...
	public function save()
	{
		...
		redirect(base_url('kecamatan/manage?alert=success&message=' . urlencode('Berhasil Input Data')));
	}
	...
	public function update()
	{
		...
		redirect(base_url('kecamatan/manage?alert=info&message=' . urlencode('Berhasil Update Data')));
	}
