	...
	<style>
		...
		@media only screen and (min-width: 992px) {
			...
			.desktop .carousel-item {
				...
				/* Ganti 'cover' dengan 'contain' agar gambar tidak terpotong */
				background-position: center center;
				/* Posisikan gambar di tengah */
				background-repeat: no-repeat;
				height: 100%;
				/* Pastikan gambar memenuhi tinggi kontainer */
			}

			.carousel {
				width: 100%;
				height: 600px;
				/* Tentukan tinggi carousel yang sesuai */
				overflow: hidden;
			}
		}
