		...
		<div class="iq-card iq-card-block iq-card-stretch iq-card-height">
			<div class="iq-card-body">
				<div class="iq-advance-course ">
					<a href="<?= base_url()?>dokumen/manage/add" class="btn btn-primary  pull-right btn-datatb "> <i class="ri-add-circle-line "></i> Tambah </a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('dokumen/manage/ajax_list')?>",
                "type": "POST"
            },
    ...
    function delete_(id) {
        if (confirm('Anda yakin ingin menghapus data ?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('dokumen/manage/ajax_delete')?>/" + id,
                type: "POST",
                dataType: "JSON",
