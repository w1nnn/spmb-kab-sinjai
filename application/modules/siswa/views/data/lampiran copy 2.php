...
<form action="<?= base_url() ?>siswa/save" method="POST" enctype="multipart/form-data">
		...
		<div class="col-md-12">
			<div class="table-responsive">
				<table class="table table-bordered table-hover">
					...
					<!-- Upload SKTM -->
					<tr>
						<td><b onclick="$(this).closest('tr').find('input[type=file]').click()"> Surat Keterangan Tidak Mampu (SKTM) Sesuai Format Panduan <span class="text-danger">*</span></b></td>
						<td>File pdf / jpg, Max 500 kb<br>
							<input type="file" style="display: inline;width: auto" accept="image/jpeg,image/x-png,application/pdf" class="form-control-file" name="sktm" onchange="previewFile(this, 'sktmPreview')">
						<!-- <input type="file" style="display: inline;width: auto" accept="image/jpeg,image/x-png,application/pdf" class="form-control-file" name="sktm" <?= ($get->sktm == "") ? "required" : ""; ?> onchange="previewFile(this, 'sktmPreview')"> -->
						</td>
						<td>
	...
	<!-- Checkbox validasi bahwa file sktm yang telah saya upload sesuai dengan format dan apabila tidak saya sisapkena angksi -->
