				...
				<div class="row">
					<div class="col-md-3 col-12">
						...
						<?php if (level_user() == "sekolah") { ?>
							...
							<a
								href="#"
								class="btn btn-sm btn-success btn-block text-left <?= $is_disabled ? 'disabled' : '' ?>"
								<?= $is_disabled ? 'onclick="return false;"' : 'data-toggle="modal" data-target="#kuota"' ?>>
								<i class="ri-edit-2-line"></i> Edit Kuota Diterima
							</a>
    ...
    <div class="col-md-12">
        <div class="card text-white bg-info iq-mb-3">
            <div class="card-body">
                <p>Sisa Kuota </p>
                <h3 class="card-title text-white">
                    <?= $get->kuota - jumlahPendaftar($get->npsn) ?> Orang
                </h3>
            </div>
        </div>
    </div>
