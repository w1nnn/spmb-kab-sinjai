...
<?php
	if(level_user() == "admin" || level_user()  == "superadmin" ){
		...
		header("Content-Disposition: attachment; filename=Data Calon Siswa Admin - ".sekolah($npsn)->nama.".xls");
...
<table>
	...
	<tr>
		<td><b> JALUR </b> </td>
		<td><b><?php if($jalur == "all"){ echo "Semua Jalur"; }else{ echo jalur($jalur)->nama; }  ?> </b> </td>
	</tr>
	<tr>
	...
	<table class="table table-hover" id="table" style="border:1px solid black;">
			...
			<td style="border:1px solid black;"><?= $no++ ?> </td>
				...
				<td style="border:1px solid black;">
					<?php if($siswa->skl == ""){ echo "-" ; }else{  echo "<a href=". base_url() ."uploads/siswa/". $siswa->skl .">". base_url() ."uploads/siswa/". $siswa->skl."</a>"; }  ?>
				</td>
				<td style="border:1px solid black;">
					<?php if($siswa->suket == ""){ echo "-" ; }else{  echo "<a href=". base_url() ."uploads/siswa/". $siswa->suket .">". base_url() ."uploads/siswa/". $siswa->suket."</a>"; }  ?>
				</td>
				<td style="border:1px solid black;">
...
<?php
	...
	if($jalur == "all"){ $jalurx ; }else{ $jalurx = jalur($jalur)->nama; }
