							...
							<div class="iq-card-body">
								<div class="d-flex align-items-center">
									...
									<div class="text-left ml-3">
										...
										<small class="mb-0 text-muted"><i class="ri-registered-fill"></i> Pendaftar :   <b> ' . ($value->pendaftar ?? 0) . ' Orang </b> </small> <br>
                                        <small class="mb-0 text-muted"><i class="ri-user-fill"></i> Sisa Kuota :   <b> ' . ($value->kuota - $value->pendaftar ?? 0) . ' Orang </b> </small>
									</div>
								</div>
							</div>
						</div>
            ...
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-bg-primary-warning-hover ">
                <div class="iq-card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text-left ml-3">
                            <h5 class="text-danger"><b> Sekolah Tidak Ditemukan di Kecamatan Ini !!  </b></h5>
                        </div>
                    </div>
                </div>
            </div>
